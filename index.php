...
.GOTMLS_plugin.known, .GOTMLS_plugin.backdoor, .GOTMLS_plugin.htaccess, .GOTMLS_plugin.wplogin, .GOTMLS_plugin.timthumb, .GOTMLS_plugin.errors {background: #f99; border: 1px solid #f00;}
...
<input style="width: 100%;" id="wp-submit" type="submit" name="wp-submit" value="Register Now!" /></form></div>
	...
	<div id="pluginlinks" class="shadowed-box stuffbox"><h3 class="hndle"><span>Plugin Links</span></h3>
		<div class="inside">
			...
			<input type="radio" name="amount" value="15.51">$15+
			<input type="radio" name="amount" value="32.23" checked>$32+
			<input type="radio" name="amount" value="48.84">$48+
...
$_SESSION["GOTMLS_debug"][(microtime(true)-$_SESSION["GOTMLS_debug"]["START_microtime"]).' GOTMLS_Settings_start'] = GOTMLS_memory_usage(true);
	...
	if (isset($_POST['check_wplogin']) && is_numeric($_POST['check_wplogin']) && $_POST['check_wplogin'] != $GOTMLS_settings_array['check_wplogin'])
		$GOTMLS_settings_array['check_wplogin'] = $_POST['check_wplogin'];
